...
export const COMMAND_REGISTRY: RegistryCommand[] = [
  ...
  // === Split Editor (Cursor `workbench.action.splitEditor*` pattern) ===
  {
    id: 'editor.splitRight',
    title: 'Split Editor Right',
    description: 'Divide o editor em 2 painéis lado-a-lado (Ctrl+])',
    icon: 'split-horizontal',
    category: 'view',
    shortcut: ['Ctrl', ']'],
    keywords: 'split editor direita right divide painel pane lado side',
  },
  {
    id: 'editor.splitDown',
    title: 'Split Editor Down',
    description: 'Divide o editor em 2 painéis cima-embaixo (Alt+])',
    icon: 'split-vertical',
    category: 'view',
    shortcut: ['Alt', ']'],
    keywords: 'split editor baixo down divide painel pane vertical',
  },
  {
    id: 'editor.closeOtherGroup',
    title: 'Close Other Editor Group',
    description: 'Fecha o painel secundário do split, voltando pro layout single',
    icon: 'close-all',
    category: 'view',
    keywords: 'close fechar split unsplit group grupo segundo secondary',
  },
  {
    id: 'editor.focusOtherGroup',
    title: 'Focus Other Editor Group',
    description: 'Alterna foco entre painéis primário/secundário do split',
    icon: 'go-to-file',
    category: 'view',
    keywords: 'focus other group focar outro grupo split alterna',
  },
  ...
  // === Settings ===
  {
    id: 'settings.open',
    title: 'Open Settings',
    description: 'Modal de configurações do UNDRCOD',
    icon: 'settings-gear',
    category: 'settings',
    shortcut: ['Ctrl', ','],
